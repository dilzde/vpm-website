...
import { Globe, Radio, Link2 } from "lucide-react";

export function YoutubeIcon({ size = 22, className }: { size?: number; className?: string }) {
  return (
...
export function XIcon({ size = 22, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export function TikTokIcon({ size = 22, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298-.002.595.042.88.13V9.4a6.33 6.33 0 0 0-1-.08A6.34 6.34 0 0 0 3 15.66a6.34 6.34 0 0 0 10.82 4.47v-7.8a8.28 8.28 0 0 0 5.77 2.33v-3.48a4.85 4.85 0 0 1-3.77-2.14z"/>
    </svg>
  );
}
