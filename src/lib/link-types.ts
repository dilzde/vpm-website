...
export const DEFAULT_LINKS: SocialLink[] = [
  {
    ...
    url: "https://vpm-website.vercel.app",
    icon: "website",
  ...
  },
  {
    ...
    icon: "youtube",
    description: "Sermons & live broadcasts",
    active: true,
    order: 3,
  },
  {
    id: "asriel-tv-247",
    label: "AsrielTV 24/7",
    url: "https://youtube.com/@asrieltv-247?si=vGyfpN7oZC8ntXRH",
    icon: "youtube",
    description: "Your 24/7 Non-Stop Stream",
    active: true,
    order: 4,
  },
  {
  ...
  },
  {
    id: "x-twitter",
    label: "X (Twitter)",
    url: "https://x.com/vpmintl?t=91u9LfmTd-SmqFpTDgBG7A&s=09",
    icon: "x",
    description: "",
    active: true,
    order: 7,
